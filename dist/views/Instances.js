...
class LabRow extends _react2.default.Component {
  ...
  render() {
    ...
    return _react2.default.createElement(_semanticUiReact.Table.Row, null, _react2.default.createElement(_semanticUiReact.Table.Cell, null, instance.lab._id), _react2.default.createElement(_semanticUiReact.Table.Cell, null, instance.username), _react2.default.createElement(_semanticUiReact.Table.Cell, null, 'assistant' in instance.lab ? instance.lab.assistant.url : _react2.default.createElement("i", null, "None")), _react2.default.createElement(_semanticUiReact.Table.Cell, null, 'machines' in instance ? instance.lab.machineOrder.map(id => _react2.default.createElement("p", {
      key: id
    }, instance.machines[id].name, " (", instance.lab.machines[id].description, ")")) : _react2.default.createElement("i", null, "None")), _react2.default.createElement(_semanticUiReact.Table.Cell, {
      singleLine: true
    }, repositories.length ? repositories : _react2.default.createElement("i", null, "None")), _react2.default.createElement(_semanticUiReact.Table.Cell, null, 'endpoints' in instance ? instance.lab.endpoints.map(id => _react2.default.createElement("p", {
      key: id
    }, _react2.default.createElement("a", {
      href: instance.endpoints[id].link,
      target: "_blank"
    }, id))) : _react2.default.createElement("i", null, "None")), _react2.default.createElement(_semanticUiReact.Table.Cell, {
      singleLine: true
    }, _react2.default.createElement("p", null, startTime.toDateString() + ' ' + startTime.toTimeString().split(' ')[0]), _react2.default.createElement("p", null, _react2.default.createElement(_util.TimeSince, {
      date: startTime
    }), " ago")), _react2.default.createElement(_semanticUiReact.Table.Cell, null, _react2.default.createElement("a", {
...
class Instances extends _react2.default.Component {
  ...
  render() {
    ...
    for (const instance of this.state.instances) {
      instances.push(_react2.default.createElement(LabRow, {
        key: instance._id,
        instance: instance
      }));
    }
    ...
    return _react2.default.createElement(_semanticUiReact.Grid, null, _react2.default.createElement(_semanticUiReact.Grid.Column, null, _react2.default.createElement(_semanticUiReact.Header, {
      size: "large",
      color: "teal"
    }, "Running Labs"), _react2.default.createElement(_semanticUiReact.Table, {
      sortable: true
    ...
    }, "Lab"), _react2.default.createElement(_semanticUiReact.Table.HeaderCell, {
      sorted: column === 'username' ? direction : null,
      onClick: this.handleSort('username')
    }, "Username"), _react2.default.createElement(_semanticUiReact.Table.HeaderCell, {
      sorted: column === 'assistant' ? direction : null,
      onClick: this.handleSort('assistant')
    }, "Assistant"), _react2.default.createElement(_semanticUiReact.Table.HeaderCell, {
      sorted: column === 'machines' ? direction : null,
      onClick: this.handleSort('machines')
    }, "Machines"), _react2.default.createElement(_semanticUiReact.Table.HeaderCell, {
      sorted: column === 'repositories' ? direction : null,
      onClick: this.handleSort('repositories')
    }, "Repositories"), _react2.default.createElement(_semanticUiReact.Table.HeaderCell, {
      sorted: column === 'endpoints' ? direction : null,
      onClick: this.handleSort('endpoints')
    }, "Endpoints"), _react2.default.createElement(_semanticUiReact.Table.HeaderCell, {
      sorted: column === 'startTime' ? direction : null,
      onClick: this.handleSort('startTime')
    }, "Start time"), _react2.default.createElement(_semanticUiReact.Table.HeaderCell, {
      colSpan: "2"
    }))), _react2.default.createElement(_semanticUiReact.Table.Body, null, instances))));
  }
