	...
	render() {
		...
		for (const id in lab.repositories) {
			repositories.push(_react2.default.createElement(
				...
				id,
				' (',
				lab.repositories[id].name,
				lab.repositories[id].head && '/' + lab.repositories[id].head,
				')'
			));
		}
		...
		return _react2.default.createElement(
			...
			_react2.default.createElement(
				_semanticUiReact.Table.Cell,
				null,
				'assistant' in lab ? lab.assistant.url : _react2.default.createElement(
					'i',
					null,
					'None'
				)
			...
			_react2.default.createElement(
				_semanticUiReact.Table.Cell,
				null,
				'machineOrder' in lab ? lab.machineOrder.map(id => _react2.default.createElement(
					'p',
					{
						key: id },
					lab.machines[id].base,
					' (',
					lab.machines[id].description,
					')'
				)) : _react2.default.createElement(
					'i',
					null,
			...
			_react2.default.createElement(
				_semanticUiReact.Table.Cell,
				{ singleLine: true },
				'endpoints' in lab ? lab.endpoints.map(name => _react2.default.createElement(
					'p',
					{ key: name },
					name
				)) : _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					{ on: 'click', position: 'top center', wide: true, hideOnScroll: true,
						trigger: _react2.default.createElement(
							...
							{ color: 'green', disabled: !!this.state.loading,
								loading: this.state.loading === 'start',
								icon: true },
							_react2.default.createElement(_semanticUiReact.Icon, { name: 'caret square right' }),
							' Start'
						),
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(_semanticUiReact.Input, { ref: 'username', placeholder: 'Username' }),
						_react2.default.createElement('br', null),
						_react2.default.createElement(
							_semanticUiReact.Button,
							{ positive: true, onClick: () => this.startLab(this.refs.username.inputRef.value) },
							'Go'
						)
					)
				)
			...
			_react2.default.createElement(
				...
				_react2.default.createElement(
					...
					{ on: 'click', position: 'top center', wide: true, hideOnScroll: true,
						trigger: _react2.default.createElement(
							_semanticUiReact.Button,
							{ color: 'violet', disabled: !!this.state.loading,
					...
					_react2.default.createElement(
						_semanticUiReact.Form,
						{ style: { marginBottom: '0px' } },
						_react2.default.createElement(_semanticUiReact.Input, { ref: 'cloneName', placeholder: 'Lab name', defaultValue: lab._id }),
						_react2.default.createElement(
							_semanticUiReact.Button,
							{ positive: true,
			...
			_react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						_semanticUiReact.Button,
						{ negative: true, onClick: () => this.deleteLab() },
						'Confirm deletion'
					)
				)
			)
...
class Labs extends _react2.default.Component {
	...
	render() {
		...
		for (const lab of this.state.labs) {
			labs.push(_react2.default.createElement(LabRow, { key: lab._id, lab: lab }));
		}
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(_semanticUiReact.Table.HeaderCell, { colSpan: 4 })
						)
					),
					_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								...
								_react2.default.createElement(
									_semanticUiReact.Popup,
									{ on: 'click', position: 'top center', wide: true,
										trigger: _react2.default.createElement(
											_semanticUiReact.Button,
											{ positive: true, disabled: !!this.state.loading,
									...
									_react2.default.createElement(
										_semanticUiReact.Form,
										{ style: { marginBottom: '0px' } },
										_react2.default.createElement(_semanticUiReact.Input, { ref: 'newName', placeholder: 'Lab name' }),
										_react2.default.createElement(
											_semanticUiReact.Button,
											{ positive: true,
