  ...
  render() {
    ...
    if (machine.state === 'running') {
      if ('rdp-port' in machine) {
        rdpOrSnapshotButton = _react2.default.createElement(_semanticUiReact.Button, {
          icon: true,
          color: "blue",
          basic: true,
      ...
      rdpOrSnapshotButton = _react2.default.createElement(_semanticUiReact.Popup, {
        on: "click",
        hideOnScroll: true,
    ...
    return _react2.default.createElement(_semanticUiReact.Table.Row, null, _react2.default.createElement(_semanticUiReact.Table.Cell, null, machine.id), _react2.default.createElement(_semanticUiReact.Table.Cell, null, machine.state), _react2.default.createElement(_semanticUiReact.Table.Cell, null), _react2.default.createElement(_semanticUiReact.Table.Cell, null, machine.snapshot), _react2.default.createElement(_semanticUiReact.Table.Cell, null), _react2.default.createElement(_semanticUiReact.Table.Cell, null, ip), _react2.default.createElement(_semanticUiReact.Table.Cell, {
      collapsing: true
    }, rdpOrSnapshotButton), _react2.default.createElement(_semanticUiReact.Table.Cell, {
      collapsing: true,
      style: {
        textAlign: 'right'
      }
...
exports.default = props => {
  const tabs = [['machine', 'All machines'], ['machine?templates', 'Templates'], ['machine?running', 'Running machines']].map((link, i) => _react2.default.createElement("a", {
    key: i,
    className: props.activeTab === i ? 'active item' : 'item',
    href: link[0]
  }, link[1]));
  const machines = props.machines.map(machine => _react2.default.createElement(Machine, {
    key: machine.id,
    machine: machine
  }));
  return _react2.default.createElement(_semanticUiReact.Grid, null, _react2.default.createElement(_semanticUiReact.Grid.Column, null, _react2.default.createElement(_semanticUiReact.Header, {
    size: "large",
    color: "teal"
  }, "Virtual machines"), _react2.default.createElement("div", {
    ...
    selectable: true
  }, _react2.default.createElement(_semanticUiReact.Table.Header, null, _react2.default.createElement(_semanticUiReact.Table.Row, null, _react2.default.createElement(_semanticUiReact.Table.HeaderCell, null, "Name"), _react2.default.createElement(_semanticUiReact.Table.HeaderCell, {
    colSpan: 2
  }, "State"), _react2.default.createElement(_semanticUiReact.Table.HeaderCell, {
    colSpan: 2
  }, "Snapshot"), _react2.default.createElement(_semanticUiReact.Table.HeaderCell, null, "IP-s"), _react2.default.createElement(_semanticUiReact.Table.HeaderCell, null), _react2.default.createElement(_semanticUiReact.Table.HeaderCell, null), _react2.default.createElement(_semanticUiReact.Table.HeaderCell, null))), _react2.default.createElement("tbody", null, machines)))));
};