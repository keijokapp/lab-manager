	...
	render() {
		...
		if (machine.state === 'running') {
			if ('rdp-port' in machine) {
				rdpOrSnapshotButton = _react2.default.createElement(
			...
			rdpOrSnapshotButton = _react2.default.createElement(
				...
				{ on: 'click', hideOnScroll: true,
					trigger: _react2.default.createElement(
						_semanticUiReact.Button,
						{ icon: true, color: 'violet',
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(_semanticUiReact.Input, { ref: 'snapshotName', placeholder: 'Snapshot name', defaultValue: this.getNextSnapshot() }),
					_react2.default.createElement(
						_semanticUiReact.Button,
						{ positive: true, onClick: () => this.createSnapshot(this.refs.snapshotName.inputRef.value) },
						'Create'
					)
				)
			);
...
exports.default = props => {
	...
	const tabs = [['machine', 'All machines'], ['machine?templates', 'Templates'], ['machine?running', 'Running machines']].map((link, i) => _react2.default.createElement(
		'a',
		{ key: i, className: props.activeTab === i ? 'active item' : 'item',
			href: link[0] },
		link[1]
	));

	const machines = props.machines.map(machine => _react2.default.createElement(Machine, { key: machine.id, machine: machine }));
