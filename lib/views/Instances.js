...
class LabRow extends React.Component {
	...
	deleteInstance() {
		...
		request.delete('lab/' + encodeURIComponent(this.props.instance.lab._id) + '/instance/' + this.props.instance.username + '?rev=' + encodeURIComponent(this.props.instance._rev))
			.then(response => {
				if(response.ok) {
