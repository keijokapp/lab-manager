...
export default class Instances extends React.Component {
	...
	handleSort(clickedColumn) {
		const { instances, column, direction, derivedDataCache } = this.state;
	...
	render() {
		const { instances, direction, column } = this.state;
			...
			<Grid>
				<Grid.Column>
					...
					<Table sortable>
						<Table.Header>
							<Table.Row>
								<Table.HeaderCell sorted={column === 'lab' ? direction : null} onClick={this.handleSort('lab')}>
									Lab
								</Table.HeaderCell>
								<Table.HeaderCell sorted={column === 'username' ? direction : null} onClick={this.handleSort('username')}>
									Username
								</Table.HeaderCell>
								<Table.HeaderCell sorted={column === 'assistant' ? direction : null} onClick={this.handleSort('assistant')}>
									Assistant
								</Table.HeaderCell>
								<Table.HeaderCell sorted={column === 'machines' ? direction : null} onClick={this.handleSort('machines')}>
									Machines
								</Table.HeaderCell>
								<Table.HeaderCell sorted={column === 'repositories' ? direction : null} onClick={this.handleSort('repositories')}>
									Repositories
								</Table.HeaderCell>
								<Table.HeaderCell sorted={column === 'endpoints' ? direction : null} onClick={this.handleSort('endpoints')}>
									Endpoints
								</Table.HeaderCell>
								<Table.HeaderCell sorted={column === 'startTime' ? direction : null} onClick={this.handleSort('startTime')}>
									Start time
								</Table.HeaderCell>
