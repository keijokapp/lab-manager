			...
			<Table.Cell collapsing>
				<Popup on="click" position="top center" wide hideOnScroll
					...
					<Form style={{ marginBottom: '0px' }}>
						...
						<Button positive onClick={() => this.startLab(this.refs.username.inputRef.current.value)}>Go</Button>
					</Form>
				</Popup>
			</Table.Cell>
			<Table.Cell collapsing>
				<Popup on="click" position="top center" wide hideOnScroll
					...
					<Form style={{ marginBottom: '0px' }}>
						...
						<Button positive
						        onClick={() => this.cloneLab(this.refs.cloneName.inputRef.current.value)}>Create</Button>
					</Form>
				</Popup>
			</Table.Cell>
			<Table.Cell collapsing>
							...
							<Table.Cell colSpan={7}>
								<Popup on="click" position="top center" wide
									...
									<Form style={{ marginBottom: '0px' }}>
										...
										<Button positive
										        onClick={() => this.newLab(this.refs.newName.inputRef.current.value)}>Create</Button>
									</Form>
								</Popup>
							</Table.Cell>
						</Table.Row>
